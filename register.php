...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    /*  ^bind_param() safely inserts $roll into the ? in the SQL query.
    ...
    */
    ...
    /*
        ^Checks if a student with the same roll number
        ^ already exists in the database.

        ^If found, it stops the process and 
        ^redirects back with an "already exists" error.
    */
    ...
    /*
        ^the sss stands for: first s for name 
        ^                    second is for roll 
        ^                    third for email
    */
